...
def main() -> None:
    ...
    Parses CLI arguments, loads configuration, generates a maze,
    writes it to a file, and call the visualization part.

    Raises:
        ValueError: If the number of CLI arguments is invalid.
    """
    try:
        if len(sys.argv) > 2:
