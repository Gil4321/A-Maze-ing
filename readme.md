...
* `parsing_config.py`: configuration parsing
* `output_generator.py`: output file generation
* `maze_regenerator.py`: maze regeneration logic
...
Prerequisites: Python 3.13+ and the required dependencies.
...
# Assuming BFS is integrated
# maze.solve() or similar
...
* **theomart**
  ...
  * MLX graphical interface (`test_mlx.py`)
  * Maze regeneration logic (`maze_regenerator.py`)
...
* **adghouai**
  ...
  * Maze generation algorithm (`mazegen/`)
